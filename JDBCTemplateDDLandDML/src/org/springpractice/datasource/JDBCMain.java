	...
	public static void main(String[] args) {
     ...
     /* DBConnect dbc=new DBConnect();
      dbc.getCircle("2");*/
	   ...
	   // dbc.getCircle("2");
	 //  System.out.println( dbc.getName(2));
	  // System.out.println( dbc.getCircle(2).getName());
	   //System.out.println( dbc.getAllCircle().size());
	    dbc.insert(new circle(67, "I will destoy those bastards"));
	    System.out.println( dbc.getAllCircle().size());
	    dbc.createTriangle();
